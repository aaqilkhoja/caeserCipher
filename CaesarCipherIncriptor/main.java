...
public  class main{
   ...
   public static void Decipher(String message)
  {
    ...
    // public static String cipher(String theMessage){
    // String message=theMessage;
    // String ciphMessage="";
   
    // //Here is where I would change the code if I wanted to use another cipher
    // //look at this https://beginnersbook.com/2013/12/java-string-split-method-example/
    // ArrayList<Character> chars =new ArrayList<Character>();
    // for(int x=0; x<message.length();x++)
    // {
        // chars.add(message.charAt(x));
    ...
    // for(int x=0;x<chars.size();x++)
    // {
    // System.out.println(chars.get(x));
// }
    // return ciphMessage;
    // }
